    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="card">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">Check out the current top drivers of the season.</p>
          <Link to="/drivers" className="text-f1-red hover:underline mt-2">View Drivers</Link>
        </div>
        <div className="card">
